...
export function FinalCTA() {
  return (
    <section className="py-32 relative overflow-hidden bg-transparent border-t border-gray-100 dark:border-neutral-900">
      ...
      <div className="max-w-[1200px] mx-auto px-6 sm:px-8 relative z-10 text-center">
        <motion.div
          ...
          className="bg-white shadow-xl dark:bg-[#050505] border border-gray-200 dark:border-neutral-800 rounded-[2rem] md:rounded-[3rem] p-12 md:p-24 relative overflow-hidden"
        >
          ...
          <div className="relative z-10">
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-medium text-gray-900 dark:text-white tracking-tight mb-8 leading-tight max-w-3xl mx-auto">
              Mulai Digitalisasi Tata Kelola Lingkungan Anda.
            </h2>
            <p className="text-lg md:text-xl text-gray-500 dark:text-neutral-400 mb-12 max-w-2xl mx-auto tracking-tight leading-relaxed font-light">
              Bergabunglah dengan komunitas residensial cerdas yang telah mentransformasi administrasi, keamanan, dan interaksi warga melalui satu platform yang terintegrasi secara profesional.
            </p>
