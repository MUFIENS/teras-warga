              ...
              if (!connected) {
                return (
                  <button
                    ...
                    type="button"
                    className="bg-gray-100 dark:bg-neutral-800 hover:bg-gray-200 dark:hover:bg-neutral-700 text-gray-900 dark:text-white font-semibold py-2 px-4 rounded-full transition-colors flex items-center gap-2"
                  >
